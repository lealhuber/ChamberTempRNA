# confustion got to big so separate script for age effect combinations in genes that do stuff in both heat and cold
# Nov 2025
# Lea Huber
...
# just one goal: colourful plot with what hot and cold genes are doing in ages (opposite, same but different, same) separately because everything else is a death wish for all involved
...
# I think I am almost there reshape again
...
# this removes quite a few genes also from other categories but that's ok I guess
