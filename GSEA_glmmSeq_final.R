...
# 11% failed to map but the rest did apparently!!
...
# set universe to only the ones I analysed
...
### should also work with GO terms
...
table(gene_sym) # so it's only 8 of the 26 in hotup that appear in the top go terms, should mark these for targeted fst
