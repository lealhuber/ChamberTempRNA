...
trim_galore --paired --fastqc --gzip --cores 8 -q 10 \
    ...
    /faststorage/project/ostrich_thermal/BACKUP/ChamberRNAseq/data/90-964973806/00_fastq/L[4-9]*.fastq.gz
# -q 10 : Rachel recommended only light quality trimming of <Q10 (instead of default <Q20)
trim_galore --paired --fastqc --gzip --cores 8 -q 10 \
    -o /faststorage/project/ostrich_thermal/BACKUP/ChamberRNAseq/data/trimmed \
    /faststorage/project/ostrich_thermal/BACKUP/ChamberRNAseq/data/90-964973806/00_fastq/L3[2-9]*.fastq.gz
# -q 10 : Rachel recommended only light quality trimming of <Q10 (instead of default <Q20)
trim_galore --paired --fastqc --gzip --cores 8 -q 10 \
    -o /faststorage/project/ostrich_thermal/BACKUP/ChamberRNAseq/data/trimmed \
    /faststorage/project/ostrich_thermal/BACKUP/ChamberRNAseq/data/90-964973806/00_fastq/L3_*.fastq.gz
# -q 10 : Rachel recommended only light quality trimming of <Q10 (instead of default <Q20)
exit 0
